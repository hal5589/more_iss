...
public class SummonedApothecarist extends ApothecaristEntity implements IMagicSummon {

    private LivingEntity owner;

    public SummonedApothecarist(EntityType<? extends AbstractSpellCastingMob> entityType, Level level) {
        super(entityType, level);
        xpReward = 0;
        this.setCustomName(Component.translatable("entity.more_iss.summoned_apothecarist"));
    ...
    public SummonedApothecarist(Level level, LivingEntity owner) {
        this(EntityRegistry.APOTHECARIST.get(), level);
        setSummoner(owner);
    }
    ...
    public void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new AlchemistAttackGoal(this, 1.25f, 30, 70, 12, 0.5f)
                .setSpells(
