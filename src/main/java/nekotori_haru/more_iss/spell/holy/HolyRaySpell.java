...
public class HolyRaySpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(More_iss.MODID, "holy_ray");
    ...
    public void onCast(Level level, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        ...
        if (!level.isClientSide) {
            BaseBeamVisualEntity visual = new BaseBeamVisualEntity(More_iss.BASE_BEAM_VISUAL.get(), level, entity, distance, BeamType.HOLY);
        ...
        if (hitResult.getType() != HitResult.Type.MISS) {
            ...
            MagicManager.spawnParticles(level, ParticleTypes.INSTANT_EFFECT, x, y, z, 15, 0.15, 0.15, 0.15, 0.05, false);
            MagicManager.spawnParticles(level, ParticleTypes.ENCHANTED_HIT, x, y, z, 15, 0.2, 0.2, 0.2, 0.2, false);
